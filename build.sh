...
PROJ=$ROOT/mineral-rights/sellmineralrightsalabama.com
REFHOST=hntb-com
VOICE=$PROJ/site-voice.json
PAGES="home=https://www.hntb.com/,about=https://www.hntb.com/about/,contact=https://www.hntb.com/contact/,index=https://www.hntb.com/project-list/,slug=https://www.hntb.com/projects/gov-mario-m-cuomo-bridge/"
...
if [ ! -f "$CAP/public/home.html.ref" ]; then
  node "$S/faithful-home.mjs" --src "https://www.hntb.com/" --pages "$PAGES" --dir "$CAP"
fi
